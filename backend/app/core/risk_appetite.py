...
def build_risk_appetite(display_years: int = 1) -> dict:
    ...
    return {
        ...
        "notes": {
            "score": "H = 50 + 50·tanh(z/2); z = 21d cumulative return spread "
                     "standardized over a rolling year. >60 risk-on, <40 defensive.",
